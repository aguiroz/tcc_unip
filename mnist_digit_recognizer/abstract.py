...
class NNScreenAbstract(NNScreenInterface, Toplevel):
    ...
    def create_model(self):
        ...
        #Labels    
        self.lb1 = Label(self, text="Informações do Dataset: ")
        self.lb2 = Label(self, text="Tamanho do Dataset de Treino: ")
        self.lb3 = Label(self, text="Quantidade de Dados de Treino: ")
        self.lb4 = Label(self, text="Tamanho do Dataset de Classificação: ")
        self.lb5 = Label(self, text="Quantidade de Dados de Teste: ")
        self.lb6 = Label(self, text="Treino ")
        self.lb7 = Label(self, text="Custo: ")
        self.lb8 = Label(self, text="Erro: ")
        self.lb9 = Label(self, text="Correto: ")
        self.lb10 = Label(self, text="Iteração: ")
        self.lb11 = Label(self, text="Lote: ")
        self.lb12 = Label(self, text="Teste ")
        self.lb13 = Label(self, text="Custo: ")
        self.lb14 = Label(self, text="Erro: ")
        self.lb15 = Label(self, text="Correto: ")
        self.lb16 = Label(self, text="Tempo Decorrido: ")
        self.lb17 = Label(self, text="Progresso: ")
        self.lb18 = Label(self, text="Treino x Teste: ")
        ...
        self.btn5 = Button(self, text="Treinar", command=self.fit)
        self.btn6 = Button(self, text="Classificar", command=self.predict)
